...
class BodyWashProfile extends StatefulWidget {
  const BodyWashProfile({super.key});

  @override
  State<BodyWashProfile> createState() => _BodyWashProfileState();
}

class _BodyWashProfileState extends State<BodyWashProfile> {
                ...
                child: IconButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const BodywashPage()));
                    },
                    icon: const Icon(
